...
def generiereWuerfel(wuerfel_startpunkt_x, wuerfel_startpunkt_y, wuerfel_startpunkt_z, seitenlaenge):
    ...
    HÖHE = ((SEITE**2) - ((SEITE/2)**2)) ** 0.5

    linien = [
        # Vorderes Quadrat
        [[0, 0, 0], [SEITE, 0, 0]],
        [[SEITE/2, HÖHE , 0], [0, 0, 0]],
        [[SEITE, 0, 0], [SEITE/2, HÖHE , 0]],
        
        # Hinteres Quadrat
        [[0, 0, SEITE], [SEITE, 0, SEITE]],
        [[SEITE/2, HÖHE , SEITE], [0, 0, SEITE]],
        [[SEITE, 0, SEITE], [SEITE/2, HÖHE , SEITE]],
        
        # Verknüpfung der Quadrate
        [[0, 0, 0], [0, 0, SEITE]],
        [[SEITE, 0, 0], [SEITE, 0, SEITE]],
        [[SEITE/2, HÖHE , 0], [SEITE/2, HÖHE , SEITE]]
    ]
