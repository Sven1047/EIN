...
def main():
    ...
    while True:
        ...
        wuerfellinien = generiereWuerfel(0, 0, 0, 100)
        ...
        # hier generieren wir den zweiten Würfel
        wuerfellinien = generiereWuerfel(25,100, 25, 50)
        
         # Zeichne den zweiten Würfel
        glBegin(GL_LINES)
        for linie in wuerfellinien:
            for koordinaten in linie:
                glVertex3fv(koordinaten)
        glEnd()
         ...
         # Zeichne den soliden Würfel (glutSolidCube erwartet die volle Kantenlänge)
        glutSolidCube(20)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                # Tasten A/D für Z 
                if event.key == pygame.K_a: # Z-Achse vorwärts 
                    glTranslatef(0, 0, move_speed) 
                    camera_z += move_speed
                if event.key == pygame.K_d: # Z-Achse rückwärts 
                    glTranslatef(0, 0, -move_speed) 
                    camera_z += move_speed
