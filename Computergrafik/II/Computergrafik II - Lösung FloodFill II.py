...
def floodfill8(x, y, alteFarbe, neueFarbe):
    if getpixelcolor(x, y) == alteFarbe:
        ...
        floodfill8(x + PIXEL_SIZE, y + PIXEL_SIZE, alteFarbe, neueFarbe)  # rechts unten
        floodfill8(x + PIXEL_SIZE, y - PIXEL_SIZE, alteFarbe, neueFarbe)  # rechts oben
        floodfill8(x - PIXEL_SIZE, y + PIXEL_SIZE, alteFarbe, neueFarbe)  # links unten
        floodfill8(x - PIXEL_SIZE, y - PIXEL_SIZE, alteFarbe, neueFarbe)  # links oben
